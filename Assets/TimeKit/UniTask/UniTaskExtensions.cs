...
namespace TimeKit
{
    public static class UniTaskExtensions
    {
         ...
         /// </summary>
         public static async Cysharp.Threading.Tasks.UniTask Delay(this IClock clock, TimeSpan delayTimeSpan, CancellationToken cancellationToken = default)
         {
         ...
         /// </summary>
         public static async Cysharp.Threading.Tasks.UniTask Delay(this IClock clock, float seconds, CancellationToken cancellationToken = default)
         {
             if (seconds < 0)
